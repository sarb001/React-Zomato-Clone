  ...
  return (
    <div className = 'explore-options'>
         ...
         <div className = "first-accordian"  onClick  = {() => setfirstshow(!firstshow)}>
                <span id = "click-accordian" >  Popular cuisines  near me    </span>
                <span>  { firstshow ?  <MdKeyboardArrowUp />  : <RiArrowDownSLine /> }   </span> 
         ...
         <div className = "second-accordian"  onClick  = {() => setsecondshow(!secondshow)}v>
                <span id = "click-accordian" >  Cities We Deliver To  </span>
                
                <span>  { secondshow ?  <MdKeyboardArrowUp />  : <RiArrowDownSLine /> }   </span> 
